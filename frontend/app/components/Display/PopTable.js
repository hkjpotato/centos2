...
var ElementRow = React.createClass({
  ...
  mouseEnter: function(data, reactevent) {
    ...
    if (reactevent.ctrlKey) {
      this.refs.myRow.style.background = 'gray';
    } else {
      this.refs.myRow.style.background = 'none';
    ...
    return (
      <div style={{position: 'relative'}}>
        ...
        <div className='real-table'>
          <table id="pgTable" className="table table-bordered table-condensed table-striped table-hover">
            <thead>
              <tr>
                {
                  attributes.map(function(attribute, i) {
